...
class Ui_manualDialog(object):
    ...
    def setupUi(self, thirdDialog):
        ...
        if (RPI_ON):
            try:
                print"hue"
                #bus.write_byte_data(address1, 0x44, RefVar)     #0.0 V
            except Exception, e:
                raise e
        self.lcdNumber.display(RefVar)
        ...
        self.lcdNumber_2.display(RefVar)
    ...
    def retranslateUi(self, thirdDialog):
        ...
        self.label_2.setText(_translate("thirdDialog", "Calibração Teste", None))
        ...
        self.pushButton_7.setText(_translate("thirdDialog", "Salva ae Gil", None))
        ...
        QtCore.QObject.connect(self.pushButton_7, QtCore.SIGNAL("clicked()") , self.getPower)
    ...
    def setPower(self):
        ...
        if (RPI_ON):
            ...
            for x in xrange(0,10):
                try:
                    print "jaja"
                    #bus.write_byte_data(address1, 0x44, RefVar)  # ajuste de 0.8 de offset
                    break
                except Exception, e:
                    # raise e
                    print"erro no DAC"
    ...
    def getPower(self):
                ...
                global cont, voltage, var0, sheet1, current
                voltage = 0;
                current = 0;
                dac_aux = 0
                temperatura = 0
                    ...
                    try:
                        if (RPI_ON):
                            for x in range(0,10):
                                ...
                                voltage += ADCvoltageTemp*5/255.0
                            voltage = voltage/x
                            ...
                            for x in range(0,10):
                                ...
                                current += ADCcurrentTemp*5/255.0
                            current = current/x
                            ...
                            data = ('Vref: '+ str(RefVar) + ' Vread: ' + str(voltage) + ' Cread: '+ str (current) + ' Pread: '  +str(power)+ '\n')
                            #Salvando valores na tabela excel
                            sheet1.write(var0,0,RefVar)
                            ...
                            var0 += 1   
                            wb1.save('calibracao_data_Teste.xls')
