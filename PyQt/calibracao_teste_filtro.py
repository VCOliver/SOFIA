...
sheet1.write(1,0,"Referencia(DAC)")
sheet1.write(1,1,"Tensao Filtrada")
sheet1.write(1,2,"Corrente Filtrada")
sheet1.write(1,3,"Tensao Media")
sheet1.write(1,4,"Corrente Media")    
...
class Ui_manualDialog(object):
    ...
    def salva(self):
        ...
        print "tamain: " + str(len(voltage_filter))
        #for voltage_filtra in np.nditer(voltage_filter):
            #print "Tensao filtra: " + str(voltage_filtra)
        ...
        #print "voltage: " + str(voltage_filtrada)
        
        #for current_filtra in np.nditer(current_filter):
            #print "Tensao filtra: " + str(current_filtra)
        b, a = signal.butter(3, 0.05)
        ...
        #print "current: " + str(current_filtrada)

        self.lcdTemp.display(current_filtrada)
        self.lcdNumber_2.display(voltage_filtrada)

        #Salvando valores na tabela excel
        sheet1.write(var0,0,voltage_input)
        sheet1.write(var0,1,voltage_filtrada)
        sheet1.write(var0,2,current_filtrada)
        sheet1.write(var0,3,voltage_save)
        sheet1.write(var0,4,current_save)
                ...
                try:
                    if(RPI_ON):
                        for x in range(0,15):
                            ...
                            #print "Arduino Tensao: " + str(ADCvoltageTemp)
                        ...
                        for x in range(0,15):
                            ...
                            #print "Arduino corrente: " + str(ADCcurrentTemp)
