            ...
            for k in range (0,10):
                try:
                    if (RPI_ON):
                        ...
                        #voltage 20w march/02
                        #voltage = 0.0056*voltage_filtrada + 12.58

                        #voltage 40w march/02
                        voltage = 0.006*voltage_filtrada + 3.1099
                        ...
                        #temperature = 0.004*temperature-1.4439
                        ...
                        sheet1.write(var0,4,impedancia)
                        #print "Index:" + str(var0)
                        var0 += 1   
                        wb1.save('Dados_temperatura.xls')
